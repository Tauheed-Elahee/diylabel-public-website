    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 dark:from-gray-800 dark:via-gray-900 dark:to-black">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in">
          ...
          <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-xl shadow-lg overflow-hidden mb-8 max-w-4xl mx-auto border border-white/20 dark:border-white/10">
            {/* Map Container */}
            <div className="relative h-64 md:h-80">
              <div className="w-full h-full bg-gradient-to-br from-blue-900/50 to-purple-900/50 dark:from-gray-900/80 dark:to-black/80 relative">
                ...
                {/* Print Shop Stats */}
                <div className="absolute top-4 left-4 bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/20 dark:border-white/10">
                ...
                <div className="absolute top-4 right-4 flex flex-col gap-2">
                  <button className="bg-white/10 dark:bg-white/5 backdrop-blur-sm p-2 rounded-lg border border-white/20 dark:border-white/10 hover:bg-white/20 dark:hover:bg-white/10 transition-colors">
            ...
            <div className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                {mockPrintShops.slice(0, 3).map((shop) => (
                  <div 
                    key={shop.id}
                    className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-lg p-3 border border-white/20 dark:border-white/10 hover:bg-white/20 dark:hover:bg-white/10 transition-all cursor-pointer"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <button className="bg-white/10 dark:bg-white/5 hover:bg-white/20 dark:hover:bg-white/10 text-white border border-white/30 dark:border-white/20 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 backdrop-blur-sm">
              Learn More
            </button>
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="w-6 h-10 border-2 border-white/50 dark:border-white/30 rounded-full flex justify-center">
          <div className="w-1 h-3 bg-white/70 dark:bg-white/50 rounded-full mt-2 animate-bounce-gentle"></div>
        </div>
      </div>
    </section>
  )
